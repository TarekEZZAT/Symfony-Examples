...
{
    /**
     * @Route("/c00110/addmany", name="addmany")
     */
    public function addmany()
    {
       ...
       $entityManager = $this->getDoctrine()->getManager();
        ...
        return $this->render('c00110\addmany.html.twig', [
            'city_name' => 'Paris',
        ]);
    ...
    /**
    * @Route("/c00110/listall", name="listall")
    */
    public function listall()
    {
        ...
        return $this->render('c00110\listall.html.twig', [
            'country_name' => 'Paris',
            'users' => $users,
        ]);
