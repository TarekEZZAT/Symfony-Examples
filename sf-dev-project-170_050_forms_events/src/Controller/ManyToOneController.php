...
//        $entityManager->flush();
    ...
    /**
     * @Route("/c00115/newvideo", name="newvideo")
     */
    public function newvideo(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $entityManager->persist($video);
            $entityManager->flush();
            return $this->redirectToRoute('newvideo');
        }
    ...
    /**
     * @Route("/c00115/updatevideo", name="updatevideo")
     */
    public function updatevideo(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid())
        {
            $entityManager->persist($video);
            $entityManager->flush();
            return $this->redirectToRoute('updatevideo');
        }
